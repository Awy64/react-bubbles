...
- [x] Explain what a token is used for.
      To make sure you are allowed access to a page or data.

- [x] What steps can you take in your web apps to keep your data secure?
      creating secure routes where the data can only be accessed by having a valid token

- [x] Describe how web servers work.
      Lots of tubes... Your server is hosted somewhere or in meny places around the world, it is assiged a ip address that is translated from a dns server from a domain name.
